  ...
  return (
    ...
    >
      <div className="mx-auto max-w-full px-4 sm:px-6 lg:px-20">
        <div className="flex flex-wrap items-center justify-evenly md:py-4 min-h-12 md:min-h-20 gap-2 md:gap-0 p-4">
          {/* LEFT */}
          ...
          {/* BRAND */}
          <div className="order-1 w-full md:order-none md:w-1/3 flex items-center flex-nowrap justify-center">
            <Link
              href="/"
              aria-label="Home"
              className="tracking-[0.4em] text-xl md:text-2xl lg:text-3xl font-semibold text-zinc-900 dark:text-zinc-100"
            >
              N A T O R I
            </Link>
          </div>
